 ...
 * @details
 * Adjust to balance syscall overhead vs. latency and memory traffic.
 * Typical values: 16 KiB (legacy), 64 KiB, 256 KiB (common sweet spots).
 */
constexpr std::size_t CHUNK            = 1u << 14;   // 16 KiB produced per kernel call

/// AES block size in bytes (by specification).
